...
with tab1:
    ...
    chest_pain = st.selectbox("Chest Pain Type", ["Typical Angina", "Atypical Angina", "Non-Angina", "Asymptomatic"])
    resting_bp = st.number_input("Resting Blood Type (mm Hg)", min_value=0, max_value=300)
    ...
    #Converting categorial inputs to numeric 
    sex = 0 if sex == "Male" else 1
    chest_pain = ["Atypical Angina", "Non-Angina", "Asymptomatic", "Typical Angina"].index(chest_pain)
    ...
    algonames = ['Decision Trees', 'Logistic Regression', 'Support Vector Machine']
    modelnames = ['DecisionTree.pkl','Logistic.pkl', 'SVM.pkl']

    predictions = []
    def prediction_heart_disease(data):
    ...
    if st.button("Submit"):
        ...
        result = prediction_heart_disease(input_data)
...
with tab2:
    ...
    st.info("""
        ...
        4. Feature values conventions: \n
            ...
            - ChestPainType: chest pain type [3: Typical Angina, 0: Atypical Angina, 1: Non-Angina Pain, 2: Asymptomatic] \n
...
""")
    #Create a file uplaoder in the sidebar
    ...
    if uploaded_file is not None:
        ...
        excepted_columns = ['Age', 'Sex', 'ChestPainType', 'RestingBP', 'Cholesterol', 'FastingBS',
        ...
        if set(excepted_columns).issubset(input_data.columns):
            ...
            input_data.to_csv('heartLR.csv')
                            
            #Display the predictions
            st.subheader("Prediction:")
            st.write(input_data)

            #Create a button to download the upload CSV file
    ...
    with tab3:
        ...
        data = {'Decision Tree': 80.97, 'Logistic Regression': 85.86, 'Support Vector Machine': 84.22}
